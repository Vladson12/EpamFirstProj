...
<html style="background-color: #000000;">
    ...
    <body style="background-color: rgba(255,255,255,0);">
        ...
        <div style="height: 70vh;background-image: url(&quot;assets/img/1348229547604-e1432042866949.jpg&quot;);background-repeat: round;background-size: cover;">
            ...
            <div id="change-me" style="background-color: rgb(255,255,255);opacity: 0.84;font-size: 1vw; max-width: 500px; margin:0 auto;">
                <div class="container">
                    <div class="row">
            ...
            <h2>Save book</h2>
                    <form method="post" action="saveBook">
                        ...
                        <label>Year:</label><br />
                        <label>
                            <input value="${book.year}" type="text" name="year">
                        </label><br />
