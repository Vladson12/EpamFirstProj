...
<div class="w3-container w3-padding">
    <div class="w3-card-4">
        ...
        <form method="post" class="w3-selection w3-light-grey w3-padding" action="editBook">
            ...
            <label>Genre: ${book.genre}
                ...
                <%--
                                Genre:
                                <input value="${book.genre}" type="text" name="genre" class="w3-input w3-animate-input w3-border w3-round-large" ><br />
                --%>
            </label>
            <label>Year:
