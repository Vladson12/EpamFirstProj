            ...
            <div class="row">
                <div class="col-md-12 align-self-center">
                    ...
                    <form name="form" action="login" method="post" onsubmit="return validate()">
                        ...
                        <label><input type="email" placeholder="<fmt:message key="authorization_page.email_ph"/>"
                                      name="login"></label><br/>
                        <label><fmt:message key="authorization_page.password"/>:</label><br/>
                        <label><input type="password" placeholder="<fmt:message key="authorization_page.password_ph"/>"
                                      name="password"></label><br/>
                        <label>
                            <button type="submit"><fmt:message key="authorization_page.signin_bn"/></button>
                        </label><br/>
                        <label><a href="${pageContext.request.contextPath}/passwordRecovery"><fmt:message
                                key="authorization_page.password_recovery"/></a></label>
                    </form>
